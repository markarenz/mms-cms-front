...
class PageHeaderOrange extends React.Component{
  constructor(props){
    super(props)
    this.state={
  ...
  render(){
    ...
    if (block.id===''){block.id='page-header-orange'}
    const blockClass = (block.class!=='') ? "page-header page-header-orange bcg-parallax " + block.class : "page-header page-header-orange bcg-parallax"
